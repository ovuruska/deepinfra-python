...
from deepinfra.types.automatic_speech_recognition.request import AutomaticSpeechRecognitionRequest
from deepinfra.types.automatic_speech_recognition.response import AutomaticSpeechRecognitionResponse
